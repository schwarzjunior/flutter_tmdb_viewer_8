...
class _CustomExpansionTileState extends State<CustomExpansionTile>
      ...
      decoration: BoxDecoration(
        ...
        border: Border.fromBorderSide(
          BorderSide(
              ...
              style: widget?.decoration?.borderWidth == 0.0
                  ? BorderStyle.none
                  : BorderStyle.solid),
        ),
        borderRadius: widget?.decoration?.borderRadius == 0.0
            ? null
  ...
  Widget get _dividerWidget {
    return (_isExpanded &&
            (widget?.decoration?.dividerThickness ?? widget?.decoration?.borderWidth) != 0.0)
        ? Divider(
            height: 0.0,
            thickness: widget?.decoration?.dividerThickness ?? widget?.decoration?.borderWidth,
